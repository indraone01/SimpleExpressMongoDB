...
export declare class ModuleCache {
    ...
    getStaticCacheKey(file: File, type?: string): string;
     ...
     * @memberOf ModuleCache
     */
    getStaticCache(file: File, type?: string): any;
    getCSSCache(file: File): any;
    /**
     *
     *
     * @param {File} file
     ...
     * @memberOf ModuleCache
     */
    writeStaticCache(file: File, sourcemaps: string, type?: string): void;
    /**
     *
     *
     * @param {File[]} files
