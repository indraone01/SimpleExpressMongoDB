...
exports.argv = options_1.argv;
exports.version = options_1.version;
exports.help = options_1.help;
...
function compile(compilerOptions, callback) {
    return __awaiter(this, void 0, void 0, function () {
        var options, compiler, build, path, step, buildSteps, nexe;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, options_1.normalizeOptionsAsync(compilerOptions)];
                case 1:
                    options = _a.sent();
                ...
                case 3:
                    ...
                    nexe = app_builder_1.compose(resource_1.default, bundle_1.default, cli_1.default, buildSteps, shim_1.default, options.plugins);
                    return [2 /*return*/, callback
                            ? void nexe(compiler).then(function () { return callback && callback(null); }, function (e) {
                                if (callback)
                                    callback(e);
                                else
                                    throw e;
